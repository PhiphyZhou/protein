...
MODULE OpenMM_Types
    ...
    integer*4, parameter :: OpenMM_GBVIForce_NoCutoff = 0
    integer*4, parameter :: OpenMM_GBVIForce_CutoffNonPeriodic = 1
    integer*4, parameter :: OpenMM_GBVIForce_CutoffPeriodic = 2
    integer*4, parameter :: OpenMM_GBVIForce_NoScaling = 0
    integer*4, parameter :: OpenMM_GBVIForce_QuinticSpline = 1
...
frequency)
        ...
        function OpenMM_MonteCarloMembraneBarostat_getTemperature(target)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloMembraneBarostat) target
            real*8 OpenMM_MonteCarloMembraneBarostat_getTemperature
        end function
        subroutine OpenMM_MonteCarloMembraneBarostat_setTemperature(target, temp)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloMembraneBarostat) target
            real*8 temp
        end subroutine
...
frequency)
        ...
        subroutine OpenMM_MonteCarloBarostat_setTemperature(target, temp)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloBarostat) target
            real*8 temp
        end subroutine
...
function)
        ...
        function OpenMM_GBVIForce_addParticle(target, charge, &
radius, &
gamma)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
        ...
        subroutine OpenMM_GBVIForce_getParticleParameters(target, index, &
charge, &
radius, &
gamma)
            use OpenMM_Types; implicit none
        ...
        subroutine OpenMM_GBVIForce_setParticleParameters(target, index, &
charge, &
radius, &
gamma)
            use OpenMM_Types; implicit none
        ...
        function OpenMM_GBVIForce_addBond(target, particle1, &
particle2, &
distance)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
        ...
        subroutine OpenMM_GBVIForce_getBondParameters(target, index, &
particle1, &
particle2, &
distance)
            use OpenMM_Types; implicit none
        ...
        subroutine OpenMM_GBVIForce_setBondParameters(target, index, &
particle1, &
particle2, &
bondLength)
            use OpenMM_Types; implicit none
        ...
        function OpenMM_GBVIForce_getNonbondedMethod(target)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
            integer*4 OpenMM_GBVIForce_getNonbondedMethod
        end function
        subroutine OpenMM_GBVIForce_setNonbondedMethod(target, method)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
            integer*4 method
        end subroutine
        ...
        subroutine OpenMM_GBVIForce_setCutoffDistance(target, distance)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
            real*8 distance
        end subroutine
        function OpenMM_GBVIForce_getBornRadiusScalingMethod(target)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
            integer*4 OpenMM_GBVIForce_getBornRadiusScalingMethod
        end function
        subroutine OpenMM_GBVIForce_setBornRadiusScalingMethod(target, method)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
            integer*4 method
        end subroutine
        ...
        subroutine OpenMM_GBVIForce_setQuinticLowerLimitFactor(target, quinticLowerLimitFactor)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
        ...
        subroutine OpenMM_GBVIForce_setQuinticUpperBornRadiusLimit(target, quinticUpperBornRadiusLimit)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
            real*8 quinticUpperBornRadiusLimit
        end subroutine
        function OpenMM_GBVIForce_usesPeriodicBoundaryConditions(target)
            use OpenMM_Types; implicit none
            type (OpenMM_GBVIForce) target
            integer*4 OpenMM_GBVIForce_usesPeriodicBoundaryConditions
        end function
...
stepSize)
        ...
        subroutine OpenMM_LocalCoordinatesSite_create(result, particle1, &
particle2, &
particle3, &
originWeights, &
xWeights, &
...
localPosition)
        ...
        subroutine OpenMM_LocalCoordinatesSite_getOriginWeights(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_LocalCoordinatesSite) target
            real*8 result(3)
        end subroutine
        subroutine OpenMM_LocalCoordinatesSite_getXWeights(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_LocalCoordinatesSite) target
            real*8 result(3)
        end subroutine
        subroutine OpenMM_LocalCoordinatesSite_getYWeights(target, result)
            use OpenMM_Types; implicit none
            type (OpenMM_LocalCoordinatesSite) target
            real*8 result(3)
        end subroutine
...
frequency)
        ...
        function OpenMM_MonteCarloAnisotropicBarostat_getTemperature(target)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloAnisotropicBarostat) target
            real*8 OpenMM_MonteCarloAnisotropicBarostat_getTemperature
        end function
        subroutine OpenMM_MonteCarloAnisotropicBarostat_setTemperature(target, temp)
            use OpenMM_Types; implicit none
            type (OpenMM_MonteCarloAnisotropicBarostat) target
            real*8 temp
        end subroutine
